 ...
 *
 * <h2>Transactions</h2>
 * The {@link dev.hytalemodding.api.transfer.v1.transaction.Transaction Transaction} system provides a
 ...
 * {@link dev.hytalemodding.api.transfer.v1.transaction.base.SnapshotParticipant SnapshotParticipant}
 * is the reference implementation of a "participant", that is an object participating in a transaction.
 *
 * <h2>Storages</h2>
 * A {@link dev.hytalemodding.api.transfer.v1.storage.Storage Storage&lt;T&gt;} is any object that can store resources of type {@code T}.
 * Its contents can be read, and resources can be inserted into it or extracted from it.
 * {@link dev.hytalemodding.api.transfer.v1.storage.StorageUtil StorageUtil} provides a few helpful function to work with {@code Storage}s,
 * for example to move resources between two {@code Storage}s.
 * The {@link dev.hytalemodding.api.transfer.v1.storage.base storage/base package} provides a few helpers to accelerate
 * implementation of {@code Storage&lt;T&gt;}.
 * Usage of {@link dev.hytalemodding.api.transfer.v1.storage.StoragePreconditions StoragePreconditions} is recommended to detect
 ...
 * {@link dev.hytalemodding.api.transfer.v1.storage.base.SingleVariantStorage SingleVariantStorage},
 * and combine them with {@link dev.hytalemodding.api.transfer.v1.storage.base.CombinedStorage CombinedStorage}.
 *
 ...
 * {@link dev.hytalemodding.api.transfer.v1.fluid.FluidVariant FluidVariant}, the immutable combination of a {@code Fluid} and additional components.
 * Instances can be accessed through the API lookups defined in {@link dev.hytalemodding.api.transfer.v1.fluid.FluidStorage FluidStorage}.
 *
 * <p>The amount for fluid transfer is droplets, that is 1/81000ths of a bucket.
 * {@link dev.hytalemodding.api.transfer.v1.fluid.FluidConstants FluidConstants} contains a few helpful constants to work with droplets.
 *
 * <p>Client-side {@linkplain dev.hytalemodding.api.transfer.v1.client.fluid.FluidVariantRendering fluid variant rendering} will use regular fluid rendering by default,
 ...
 * {@link dev.hytalemodding.api.transfer.v1.client.fluid.FluidVariantRenderHandler FluidVariantRenderHandler}.
 *
 * <h2>Item transfer</h2>
 ...
 * {@link dev.hytalemodding.api.transfer.v1.item.PlayerInventoryStorage PlayerInventoryStorage} when interaction with
 * {@code Inventory}-based APIs is required.
 *
 * <h2>{@code ContainerItemContext}</h2>
 * {@link dev.hytalemodding.api.transfer.v1.context.ContainerItemContext ContainerItemContext} is a context designed for {@code ItemApiLookup} queries
