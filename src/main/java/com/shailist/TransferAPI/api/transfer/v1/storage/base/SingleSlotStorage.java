...
/**
 * A combined type representing a single-slot storage: it is both a {@link SlottedStorage} and a {@link StorageView}.
 *
 * <p>This is useful for APIs that want to treat a single slot as both a view and a slotted container.
 *
